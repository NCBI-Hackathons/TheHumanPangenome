...
venn.diagram(list(all=var1.snps$var.id, regional=var2.snps$var.id),
             filename='venn-snps-all-regional.tiff',
...
venn.diagram(list(all=var1.indels$var.id, regional=var2.indels$var.id),
             filename='venn-indels-all-regional.tiff',
             col='transparent', fill=c('steelblue', 'indianred2'))
```
